(function () {
    ...
    function init() {
        const input = document.getElementById('vamd-search-input');
        const btn = document.getElementById('vamd-search-btn');
        const master = document.getElementById('vamd-master-placeholder');
        const detail = document.getElementById('vamd-detail-placeholder');

        async function doSearch() {
            const q = input.value || '';
            try {
                master.innerHTML = 'Searching...';
                // reuse existing endpoint from AuthorsMasterDetail
        ...
        function attachMasterHandlers() {
            const items = master.querySelectorAll('.amd-author-item');
            items.forEach(it => {
                it.addEventListener('click', async function (ev) {
                    ...
                    try {
                        ...
                        // reuse existing endpoint for author books
